...
export default function BannerForm({
    ...
    onSubmit: (values: BannerDto) => void
    initialValues?: BannerDto
}) {
    const [values, setValues] = useState<BannerDto>(initialValues || { imageUrl: '', link: '' })
        ...
        >
            <Stack spacing={5}>
                <FormControl>
                    ...
                    />
                    {errors.imageUrl && (
                        <FormHelperText sx={{ color: 'red' }}>{errors.imageUrl}</FormHelperText>
                    )}
                </FormControl>
                ...
                <FormControl>
                    ...
                    />
                    {errors.link && (
                        <FormHelperText sx={{ color: 'red' }}>{errors.link}</FormHelperText>
                    )}
                </FormControl>
            </Stack>
        </form>
